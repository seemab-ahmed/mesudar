  ...
  return (
     <div>
        <div className="max-w-[1080px] 2xl:max-w-[1440px] m-auto px-5 ">
            <div className="bg-white flex-col flex md:flex-row justify-between gap-6  pt-[66px] pb-[44px]">
                ...
                <div className="md:max-w-[398px] w-full">
                    <div className="flex max-w-[228px] mb-[24px] logo text-[30px] font-bold text-[#13AE8D]">
                    ...
                    <div className=" flex gap-4 text-sm flex-wrap font-medium text-gray-700">
                        ...
                        <ul className="m-0 p-0 flex items-center gap-4">
                            ...
                            <li>
                                <Link to="/">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18.2437 2.97754H21.5531L14.325 11.2369L22.8281 22.4775H16.1719L10.9547 15.6619L4.99216 22.4775H1.6781L9.40779 13.6416L1.25623 2.97754H8.08123L12.7922 9.20723L18.2437 2.97754ZM17.0812 20.4994H18.914L7.08279 4.85254H5.11404L17.0812 20.4994Z" fill="#13AE8D"/>
                                </svg>
       ...
       <div className="copy-right py-5 border-t border-[#D1D1D1] px-4">
                <span className="w-full block text-center text-[14px] font-[Inter] leading-6 text-[#1E1E1E] font-normal">Copyright 2025. All Rights Reserved.</span>
            </div>
    </div>
  );
};
