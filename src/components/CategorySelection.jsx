    ...
    <div className="bg-[#fcf1e6] rounded-xl px-3 sm:px-6 py-10">
      ...
      <div className="text-center mb-10">
        <div className="text-[#535252] ">
          <p className="sm:text-[40px] text-[34px] font-bold">Select a Checklist Template</p>
        </div>
      </div>

      {/* Category Cards */}
      <div className="grid sm:grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-6 w-full lg:max-w-[85%] m-auto">
        {categoryObjects.map((category) => (
          <button
            key={category._id}
            onClick={() => onSelect(category)}
